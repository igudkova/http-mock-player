...
namespace HttpMockReq.HttpMockReqException
{
    ...
    public class CassetteException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CassetteException"/> class with a specified error message and cassette path.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CassetteException"/> class with a specified error message, cassette path and a reference to the inner exception that is the cause of this exception.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        /// <param name="path">The path of the cassette file.</param>
        /// <param name="inner">The exception that is the cause of the current exception.</param>
